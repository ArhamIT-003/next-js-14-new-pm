...
import { GetAllUser } from "@/app/hooks/user/getUser";
...
export default function UserTable() {
  ...
  const { data: fetchedUserData, mutate } = GetAllUser();

  const data = useMemo(() => fetchedUserData ?? [], [fetchedUserData]);
      ...
      case "status":
        return (
          <Chip
            ...
            color={statusColorMap[user.isActive]}
            size="sm"
            variant="flat"
          >
          ...
          <div className="relative flex justify-end items-center gap-2">
            <Dropdown>
              ...
              <DropdownMenu color="primary">
                <DropdownItem
                  as={Link}
                  href={`/dashboard/user/update/${user._id}`}
